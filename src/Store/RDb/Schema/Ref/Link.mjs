...
Fl32_Teq_User_Store_RDb_Schema_Ref_Link.A_CODE = 'code';
Fl32_Teq_User_Store_RDb_Schema_Ref_Link.A_DATE_EXPIRED = 'date_expired';
Fl32_Teq_User_Store_RDb_Schema_Ref_Link.A_USER_REF = 'user_ref';
Fl32_Teq_User_Store_RDb_Schema_Ref_Link.ENTITY = 'user_ref_link';
