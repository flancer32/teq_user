...
export default function (spec) {
     ...
     * @return {Promise<Fl32_Teq_User_Shared_Service_Route_SignOut_Response|TeqFw_Core_Front_Gate_Response_Error>}
     * @exports Fl32_Teq_User_Shared_Service_Gate_SignOut
     */
    async function Fl32_Teq_User_Shared_Service_Gate_SignOut(data) {
        try {
    ...
    return Fl32_Teq_User_Shared_Service_Gate_SignOut;
}
