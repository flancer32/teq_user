 ...
 */
// MODULE'S VARS
const NS = 'Fl32_Teq_User_Shared_Service_Dto_RefLink';

// MODULE'S CLASSES
export default class Fl32_Teq_User_Shared_Service_Dto_RefLink {
    /** @type {Date} */
    dateExpired
...
Fl32_Teq_User_Shared_Service_Dto_RefLink.DATE_EXPIRED = 'dateExpired';
Fl32_Teq_User_Shared_Service_Dto_RefLink.PARENT = 'parent';
Fl32_Teq_User_Shared_Service_Dto_RefLink.REF_CODE = 'refCode';

/**
 * Factory to create new DTO instances.
 * @memberOf Fl32_Teq_User_Shared_Service_Dto_RefLink
 */
export class Factory {
    constructor(spec) {
         ...
         * @return {Fl32_Teq_User_Shared_Service_Dto_RefLink}
         */
        this.create = function (data = null) {
            const res = new Fl32_Teq_User_Shared_Service_Dto_RefLink();
