 ...
 * @namespace Fl32_Teq_User_Shared_WAPI_RefLink_Create
 */
// MODULE'S VARS
const NS = 'Fl32_Teq_User_Shared_WAPI_RefLink_Create';

// MODULE'S CLASSES
/**
 * @memberOf Fl32_Teq_User_Shared_WAPI_RefLink_Create
 */
class Request {}
...
class Factory {
    constructor(spec) {
        ...
        const DLink = spec['Fl32_Teq_User_Shared_Dto_RefLink#']; 
        /** @type {Fl32_Teq_User_Shared_Dto_RefLink.Factory} */
        const fLink = spec['Fl32_Teq_User_Shared_Dto_RefLink#Factory$']; 
         ...
         * @return {Fl32_Teq_User_Shared_WAPI_RefLink_Create.Request}
         */
         ...
         * @return {Fl32_Teq_User_Shared_WAPI_RefLink_Create.Response}
         */
