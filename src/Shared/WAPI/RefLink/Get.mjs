 ...
 * @namespace Fl32_Teq_User_Shared_WAPI_RefLink_Get
 */
// MODULE'S VARS
const NS = 'Fl32_Teq_User_Shared_WAPI_RefLink_Get';

// MODULE'S CLASSES
/**
 * @memberOf Fl32_Teq_User_Shared_WAPI_RefLink_Get
 */
class Request {
    /** @type {string} */
    code;
...
class Factory {
    constructor(spec) {
         ...
         * @return {Fl32_Teq_User_Shared_WAPI_RefLink_Get.Request}
         */
         ...
         * @return {Fl32_Teq_User_Shared_WAPI_RefLink_Get.Response}
         */
