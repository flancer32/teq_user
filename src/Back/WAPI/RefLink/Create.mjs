 ...
 *
 * @namespace Fl32_Teq_User_Back_WAPI_RefLink_Create
 */
// MODULE'S IMPORT
import {constants as H2} from 'http2';

// MODULE'S VARS
const NS = 'Fl32_Teq_User_Back_WAPI_RefLink_Create';

/**
 * @implements TeqFw_Web_Back_Api_WAPI_IFactory
 */
export default class Fl32_Teq_User_Back_WAPI_RefLink_Create {
    ...
    constructor(spec) {
        ...
        const route = spec['Fl32_Teq_User_Shared_WAPI_RefLink_Create#Factory$'];
        ...
        this.getService = function () {
            ...
            async function service(context) {
                ...
                // MAIN FUNCTIONALITY
                /** @type {Fl32_Teq_User_Shared_WAPI_RefLink_Create.Request} */
